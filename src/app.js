...
import ShowAppliedCampaign from "./influencerModule/influencerModules/apppliedCampaign/appliedCampaign";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          exact
          path="/bdashboard/showCamapign/editcampaign"
          element={<EditCampaign />}
        />
        <Route
          exact
          path="/Bdashboard/showCamapign"
