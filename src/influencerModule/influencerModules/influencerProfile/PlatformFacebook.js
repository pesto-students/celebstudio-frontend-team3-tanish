  ...
  const handleFacebookUpdate = (event) => {
    ...
    axios(facebookrequest)
      .then((res) => {
        ...
        toast.success("Facebook update successfully", {
      ...
      .catch((err) => {
        console.log(err);
        toast.error("Facebook update failed", {
          position: toast.POSITION.TOP_RIGHT,
        });
        setIsLoading(false);
      });
        ...
        <div className="personalDetails">
          {facebookdata.isactive ? (
            <div className="pdetails platformContainer">
              ...
              >
                Change facebook details
              </div>
              {!showEditForm ? (
                <div>
                  <div className="pdetails platform">
                    <label>ProfileUrl</label> <br />
                    <div className="PDdisplay">{facebookdata.url}</div>
                    <br />
                    <label>FollowerCount</label>
                    <br />
                    <div className="PDdisplay">
                      {facebookdata.follower_count}
                    </div>
                    <br />
                    <label>Post COST</label> <br />
                    <div className="PDdisplay">{facebookdata.cost}</div>
                    <br />
                  </div>
                </div>
              ) : (
