  ...
  const handleFacebookUpdate = (event) => {
    ...
    axios(twitterRequest)
      .then((res) => {
        ...
        toast.success("Twitter update successfully", {
      ...
      .catch((err) => {
        console.log(err);
        toast.error("Twitter update failed", {
          position: toast.POSITION.TOP_RIGHT,
        });
        setIsLoading(false);
      });
        ...
        <div className="personalDetails">
          {twitter.isactive ? (
            <div className="pdetails platformContainer">
              ...
              >
                Change twitter details
              </div>
              {!showEditForm ? (
                <div>
                  <div className="pdetails platform">
                    <label>ProfileUrl</label> <br />
                    <div className="PDdisplay">{twitter.url}</div>
                    <br />
                    <label>FollowerCount</label>
                    <br />
                    <div className="PDdisplay">{twitter.follower_count}</div>
                    <br />
                    <label>Post COST</label> <br />
                    <div className="PDdisplay">{twitter.cost}</div>
                    <br />
                  </div>
                </div>
              ) : (
