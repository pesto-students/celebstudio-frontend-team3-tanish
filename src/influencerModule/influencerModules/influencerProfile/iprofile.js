...
const Iprofile = () => {
    ...
    switch (setEdit) {
      ...
      case "lname": {
        ...
        axios(request)
          .then((res) => {
            console.log(res.data.data);
            toast.success("LastName changed successfully", {
              position: toast.POSITION.TOP_RIGHT,
            });
            setIsLoading(false);
            let data = res.data.data.profile;
      ...
      case "DOB": {
        ...
        axios(request)
          .then((res) => {
            console.log(res.data.data);
            toast.success("DOB changed successfully", {
              position: toast.POSITION.TOP_RIGHT,
            });
            setIsLoading(false);
            let data = res.data.data.profile;
      ...
      case "PC": {
        ...
        axios(request)
          .then((res) => {
            console.log(res.data.data);
            toast.success("Product category changed successfully", {
              position: toast.POSITION.TOP_RIGHT,
            });
            setIsLoading(false);
            let data = res.data.data.profile;
          ...
          .catch((err) => {
            toast.error("Product category update failed!", {
              position: toast.POSITION.TOP_RIGHT,
            });
            setIsLoading(false);
            console.log(err);
  ...
  const handlePasswordSubmit = (event) => {
    ...
    axios(passwordChangeRequest)
      ...
      .catch((err) => {
        console.log(err);
        toast.error("Paswword update failed!", {
          position: toast.POSITION.TOP_RIGHT,
        });
        setIsLoading(false);
      });
      ...
      <div className="profileContainer">
        ...
        <div className="personalDetails">
          <div
            ...
            onMouseOver={() => setShowEditButton("fname")}
          >
            {setEdit !== "fname" ? (
              <div>
                ...
                {showEditButton === "fname" ? (
                  <button
                    className="profileEditButton"
                    onClick={() => {
                      handleupdateSetEdit({ tag: "fname" });
                    }}
                  >
                    Change
                  </button>
          ...
          <div
            className="pdetails"
            onMouseOut={() => setShowEditButton()}
            onMouseOver={() => setShowEditButton("lname")}
          >
            {setEdit !== "lname" ? (
              <div>
                ...
                {showEditButton === "lname" ? (
                  <button
                    className="profileEditButton"
                    onClick={() => {
                      handleupdateSetEdit({ tag: "lname" });
                    }}
                  >
                    Change
                  </button>
          ...
          <div
            className="pdetails"
            onMouseOut={() => setShowEditButton()}
            onMouseOver={() => setShowEditButton("DOB")}
          >
            {setEdit !== "DOB" ? (
              <div>
                <label>DOB</label>
          ...
          >
            {setEdit !== "contact" ? (
              <div>
                ...
                {showEditButton === "contact" ? (
                  <button
                    className="profileEditButton"
                    onClick={() => {
                      handleupdateSetEdit({ tag: "contact" });
                    }}
                  >
                    Change
                  </button>
        ...
        <div className="personalDetails">
          <div
            className="pdetails"
            onMouseOut={() => setShowEditButton()}
            onMouseOver={() => setShowEditButton("PC")}
          >
            {setEdit !== "PC" ? (
              <div>
                <div className="PDdisplay">
                  {primaryCatagory == 0
                    ? " Please update product category"
                    : productCategory.map((item) =>
                        item.id == primaryCatagory ? item.category : null
                      )}
                </div>
                {showEditButton === "PC" ? (
                  <button
                ...
                <div className="PDdiaply">
                  ...
                  >
                    <option value="default">
                      {" "}
                      Please select a Product catagory
                    </option>
                  ...
                  <button
                    className="profileEditButton update"
